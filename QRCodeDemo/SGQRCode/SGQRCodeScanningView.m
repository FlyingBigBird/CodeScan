...
- (void)beginRefreshUI {
    ...
    if (self.scanningAnimationStyle == ScanningAnimationStyleGrid) {
        ...
        if (flag) {
            ...
            if (weakself.scanningline.frame.origin.y >= - scanBorderW) {
                
                CGFloat scanContent_MaxY = - scanBorderW + self.frame.size.width - 2 * scanBorderX;
                
                if (weakself.scanningline.frame.origin.y >= scanContent_MaxY) {
        ...
        if (flag) {
            ...
            if (weakself.scanningline.frame.origin.y >= scanBorderY) {
                
                CGFloat scanContent_MaxY = scanBorderY + self.frame.size.width - 2 * scanBorderX;
                
                if (weakself.scanningline.frame.origin.y >= scanContent_MaxY - 10) {
